...
for file_name in file_names: 
    ...
    with open(file_name, "r") as somefile:
        ...
        if not any (string in file_contents.lower() for string in ["xss","csrf","redirect","category: correctness","category: best-practice","this rule has been deprecated","improper encoding or escaping of output","insecure algorithm","cryptographic failures"]):
            print(file_name)